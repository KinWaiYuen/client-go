...
import (
	...
	"github.com/KinWaiYuen/client-go/v2/internal/kvrpc"
...
func (c *Client) CompareAndSwap(ctx context.Context, key, previousValue, newValue []byte, ttl=0 uint64) ([]byte, bool, error) {
	if !c.atomic {
